...
public class EmploymentVerificationApi {
	...
	public okhttp3.Call getEmploymentVerificationCall(String xApiKey, String inquiryId,
	...
	private okhttp3.Call getEmploymentVerificationValidateBeforeCall(String xApiKey, String inquiryId,
			final ProgressResponseBody.ProgressListener progressListener,
			final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		if (xApiKey == null) {
		...
		okhttp3.Call call = getEmploymentVerificationCall(xApiKey, inquiryId, progressListener,
	...
	public ApiResponse<AckSuccessEVConsumption> getEmploymentVerificationWithHttpInfo(String xApiKey, String inquiryId)
			throws ApiException {
	...
	public okhttp3.Call getEmploymentVerificationAsync(String xApiKey, String inquiryId,
			final ApiCallback<AckSuccessEVConsumption> callback) throws ApiException {
		...
		okhttp3.Call call = getEmploymentVerificationValidateBeforeCall(xApiKey, inquiryId, progressListener,
				progressRequestListener);
		Type localVarReturnType = new TypeToken<AckSuccessEVConsumption>() {
		}.getType();
	...
	public okhttp3.Call getEmploymentVerificationsCall(String xApiKey, String page, String perPage,
	...
	private okhttp3.Call getEmploymentVerificationsValidateBeforeCall(String xApiKey, String page, String perPage,
			OffsetDateTime startAt, OffsetDateTime endAt, String inquiryStatus, String successCheck,
			final ProgressResponseBody.ProgressListener progressListener,
			final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		if (xApiKey == null) {
		...
		okhttp3.Call call = getEmploymentVerificationsCall(xApiKey, page, perPage, startAt, endAt, inquiryStatus,
				successCheck, progressListener, progressRequestListener);
		return call;
	}

	public EmploymentVerificationMetadata getEmploymentVerifications(String xApiKey, String page, String perPage,
			OffsetDateTime startAt, OffsetDateTime endAt, String inquiryStatus, String successCheck)
			throws ApiException {
		ApiResponse<EmploymentVerificationMetadata> resp = getEmploymentVerificationsWithHttpInfo(xApiKey, page,
	...
	public ApiResponse<EmploymentVerificationMetadata> getEmploymentVerificationsWithHttpInfo(String xApiKey,
		...
		okhttp3.Call call = getEmploymentVerificationsValidateBeforeCall(xApiKey, page, perPage, startAt, endAt,
	...
	public okhttp3.Call getEmploymentVerificationsAsync(String xApiKey, String page, String perPage,
			OffsetDateTime startAt, OffsetDateTime endAt, String inquiryStatus, String successCheck,
	...
	public okhttp3.Call postEmploymentVerificationCall(String xApiKey, EmploymentVerification request,
			final ProgressResponseBody.ProgressListener progressListener,
			final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
	...
	private okhttp3.Call postEmploymentVerificationValidateBeforeCall(String xApiKey, EmploymentVerification request,
			final ProgressResponseBody.ProgressListener progressListener,
			final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		if (xApiKey == null) {
			throw new ApiException(
		...
		if (request == null) {
			throw new ApiException(
					"Missing the required parameter 'request' when calling postEmploymentVerification(Async)");
		}
	...
	public ApiResponse<AckEVRequest> postEmploymentVerificationWithHttpInfo(String xApiKey,
			EmploymentVerification request) throws ApiException {
	...
	public AckEVRequest employmentverificationsWithPrivacyNotice(EmploymentVerificationWithPrivacyNotice body,
			String xApiKey) throws ApiException {
		ApiResponse<AckEVRequest> resp = employmentverificationsWithPrivacyNoticeWithHttpInfo(body, xApiKey);
		return resp.getData();
	}

	public ApiResponse<AckEVRequest> employmentverificationsWithPrivacyNoticeWithHttpInfo(
			EmploymentVerificationWithPrivacyNotice body, String xApiKey) throws ApiException {
		okhttp3.Call call = employmentverificationsWithPrivacyNoticeValidateBeforeCall(body, xApiKey, null, null);
		Type localVarReturnType = new TypeToken<AckEVRequest>() {
		}.getType();
		return apiClient.execute(call, localVarReturnType);
	}
	...
	private okhttp3.Call employmentverificationsWithPrivacyNoticeValidateBeforeCall(
			EmploymentVerificationWithPrivacyNotice body, String xApiKey,
			final ProgressResponseBody.ProgressListener progressListener,
			final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
		if (body == null) {
			throw new ApiException(
		...
		if (xApiKey == null) {
			throw new ApiException(
					"Missing the required parameter 'xApiKey' when calling employmentverificationsWithPrivacyNotice(Async)");
		}

		okhttp3.Call call = employmentverificationsWithPrivacyNoticeCall(body, xApiKey, progressListener,
				progressRequestListener);
		return call;
	...
	public okhttp3.Call employmentverificationsWithPrivacyNoticeCall(EmploymentVerificationWithPrivacyNotice body,
			String xApiKey, final ProgressResponseBody.ProgressListener progressListener,
			final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
